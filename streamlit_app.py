...
with tab3:
    ...
    t3_w0 = col1.number_input("Peso w0", value=0.0, format="%.2f")
    t3_w1 = col2.number_input("Peso w1", value=0.0, format="%.2f")
    t3_w2 = col3.number_input("Peso w2", value=0.0, format="%.2f")
    ...
    t3_b = col1.number_input("Sesgo b", value=0.0, format="%.2f")
