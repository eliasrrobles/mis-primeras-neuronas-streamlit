...
with tab1:
    t1_w = st.slider("Peso w", value=0.0, min_value=0.0, max_value=10.0, format="%.2f")
    t1_x = st.number_input("Entrada x", value=0.0, format="%.2f")
...
with tab2:
    ...
    t2_w0 = col1.slider("Peso w0", value=0.0, min_value=0.0, max_value=10.0, format="%.2f")
    t2_w1 = col2.slider("Peso w1", value=0.0, min_value=0.0, max_value=10.0, format="%.2f")

    t2_x0 = col1.number_input("Entrada x0", value=0.0, format="%.2f")
    t2_x1 = col2.number_input("Entrada x1", value=0.0, format="%.2f")
...
with tab3:
    ...
    t3_w0 = col1.slider("Peso w0", value=0.0, min_value=0.0, max_value=10.0, format="%.2f")
    t3_w1 = col2.slider("Peso w1", value=0.0, min_value=0.0, max_value=10.0, format="%.2f")
    t3_w2 = col3.slider("Peso w2", value=0.0, min_value=0.0, max_value=10.0, format="%.2f")
